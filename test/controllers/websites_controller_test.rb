...
class WebsitesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create website" do
    assert_difference('Website.count') do
      post websites_url, params: { website: { category_id: @website.category_id, title: @website.title, url: @website.url, urlImage: @website.urlImage } }
    end
  ...
  test "should update website" do
    patch website_url(@website), params: { website: { category_id: @website.category_id, title: @website.title, url: @website.url, urlImage: @website.urlImage } }
